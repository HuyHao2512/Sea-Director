      ...
      showAlert(confirmMessage, {
        ...
        onConfirm: async () => {
          try {
            ...
            const result = await importIndexedDBData(payload, {
              mode: "merge",
            });
