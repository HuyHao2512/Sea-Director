...
[![æ—¥æœ¬èªž](https://img.shields.io/badge/Language-æ—¥æœ¬èªž-gray.svg)](./README_JA.md)
[![License: CC BY-NC-SA 4.0](https://img.shields.io/badge/License-CC%20BY--NC--SA%204.0-lightgrey.svg)](https://creativecommons.org/licenses/by-nc-sa/4.0/)

**AI Director** is an **AI-powered, one-stop platform** for **short dramas** and **motion comics**, built for creators who want to go from idea to final video fast.

Moving away from the traditional "slot machine" style of random generation, AI Director adopts an industrial **"Script-to-Asset-to-Keyframe"** workflow. With deep integration of advanced AI modelsâ€™s advanced AI models, it enables **one-sentence to complete drama** â€” fully automated from **script** to **final video**, while maintaining precise control over character consistency, scene continuity, and camera movement.
## UI Showcase
...
![Script & Story](./images/å‰§æœ¬ä¸Žæ•…äº‹.png)
...
![Shots & Frames](./images/é•œå¤´ä¸Žå¸§.png)
![Shots & Frames Detail](./images/é•œå¤´ä¸Žå¸§1.png)

### Phase 04: Export
![Export](./images/æˆç‰‡å¯¼å‡º.png)

### Prompt Management
![Prompt Management](./images/æç¤ºè¯ç®¡ç†.png)
## Core Philosophy: Keyframe-Driven

Traditional Text-to-Video models often struggle with specific camera movements and precise start/end states. AI Director introduces the animation concept of **Keyframes**:
...
## Why Choose Advanced AI Models?

This project deeply integrates [**advanced AI models platform**](https://api.example.com/), delivering exceptional value for creators:

### ðŸŽ¯ Full Model Coverage
...
[**Sign Up for Free Credits**](https://api.example.com/) â†’

## âš ï¸ Open-Source & â€œFreeâ€ Clarification (Please Read)

* **Model usage note**: This open-source projectâ€™s default workflow requires a capability-matched model stack, for example an LLM (such as **GPT-5.2**), an image model (such as **Nano Banana Pro**), and a video model (such as **Sora-2** / **Veo-3.1**). If you want to connect other providers or models, you can modify and adapt it yourself.
...
* **About â€œalways freeâ€ expectations**: If your primary criterion is long-term â€œmust be free,â€ this project may not be the best fit for you.

---

## ðŸ’¬ Join Our Community

Scan the QR code to join our **AI Director Community** on WeChat. Connect with fellow creators, share tips, and get the latest updates:
...
### ðŸŽ¨ Lightweight Creation Tools

For **quick one-off creative tasks**, try our online tool platform:

**[AI Director Studio](https://aidirector.tree456.com/)** offers:
* ðŸ“· **[AI Image Generation](https://aidirector.tree456.com/gemini-image.html)**: Text-to-image with multiple styles
* ðŸ“Š **[AI PowerPoint](https://aidirector.tree456.com/ppt-content.html)**: Generate presentations instantly
* ðŸŽ¬ **[AI Video](https://aidirector.tree456.com/ai-video-content.html)**: Intelligent video content generation
* ðŸ“± **[Social Media Content](https://aidirector.tree456.com/redink-content.html)**: Viral titles and posts for Xiaohongshu
* ðŸ“– **[AI Novel Creation](https://aidirector.tree456.com/novel-creation.html)**: Intelligent novel generation and continuation
* ðŸŽ¨ **[AI Anime Generation](https://aidirector.tree456.com/anime-content.html)**: Anime-style image creation
* ðŸŽ­ **No Installation**: Use directly in browser, instant access
...
Download the installer and get started right away â€” no development environment needed:

**[ðŸ“¥ Download AI Director Setup (Windows)](https://tree456.oss-cn-beijing.aliyuncs.com/AI%20Director%20Setup%201.0.0.exe)**

> ðŸ’¡ Just download and install â€” supports Windows.
...
1.  **Configure Key**: Launch the app and input your API Key for advanced AI models. [**Get API Key**](https://api.example.com)
...
- âŒ Commercial use prohibited (requires commercial license)

For commercial licensing, please contact: support@aidirector.com

---
*Built for Creators, by AI Director.*
