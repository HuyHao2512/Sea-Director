      ...
      <div className="border-b border-[var(--border-primary)] bg-[var(--bg-base)]/85 backdrop-blur-sm sticky top-0 z-10">
        <div className="max-w-7xl mx-auto px-6 py-6 space-y-5">
          <div className="flex flex-wrap items-start justify-between gap-4">
            <div>
              <h1 className="text-2xl font-bold text-[var(--text-primary)] mb-1">Quản lý Prompt</h1>
              <p className="text-sm text-[var(--text-tertiary)]">Quản lý trung tâm, tìm kiếm và chỉnh sửa cấu trúc lệnh của nhân vật/bối cảnh/đạo cụ</p>
            </div>
          ...
          <div className="flex flex-col xl:flex-row xl:items-center gap-3">
            <div className="relative flex-1 min-w-[240px]">
              ...
              <input
                ...
                placeholder="Tìm prompt, nhân vật, bối cảnh, hành động..."
        ...
        <div className="p-6 max-w-7xl mx-auto space-y-6">
          ...
          {!hasNoData && !hasFilteredResults && (
            <div className="rounded-xl border border-[var(--border-primary)] bg-[var(--bg-elevated)] p-8 text-center">
              <p className="text-base text-[var(--text-secondary)] mb-2">Không tìm thấy kết quả nào trùng khớp</p>
              <p className="text-sm text-[var(--text-tertiary)] mb-4">
                Vui lòng đổi thư mục lọc hoặc xóa từ khóa tìm kiếm rồi thử lại
              </p>
          ...
          {hasNoData && (
            <div className="text-center py-16 rounded-xl border border-[var(--border-primary)] bg-[var(--bg-elevated)]">
              <div className="text-[var(--text-muted)] mb-4">
                 ...
                 <p className="text-sm mt-2">Hãy tạo nhân vật/bối cảnh trước, hoặc sinh phân cảnh bằng Bàn đạo diễn nhé!</p>
              </div>
            </div>
          )}
        </div>
