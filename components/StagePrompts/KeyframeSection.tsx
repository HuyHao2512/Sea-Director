          ...
          <div key={shot.id} className={STYLES.card.base}>
            <div className="mb-3">
              ...
              <p className="text-xs text-[var(--text-muted)] mt-1">
                {shot.cameraMovement} · {shot.shotSize || 'Ống kính tiêu chuẩn'}
              </p>
            </div>
                  ...
                  <div className="flex items-center justify-between mb-2">
                    <div className="flex items-center gap-2">
                      <span className={
                        ...
                        {keyframe.type === 'start' ? 'Khung hình đầu' : 'Khung hình cuối'}
                      </span>
                          ...
                          {shot.interval.videoPrompt || (
                            <span className="text-[var(--text-tertiary)]">
                              ...
                              <span className="block mt-1 text-[var(--warning)]">
                                ⚠ Video này không lưu prompt khi sinh, nội dung trên là suy luận
                              </span>
                            </span>
                          )}
                        </p>
