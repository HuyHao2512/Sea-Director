        ...
        <div>
          ...
          <div className="flex items-center gap-6 mt-3">
            <div className={STYLES.statusPanel.stat}>
              <span className={STYLES.statusPanel.statLabel}>Số cảnh (Shots)</span>
            ...
            <div className={STYLES.statusPanel.stat}>
              ...
              <span className={STYLES.statusPanel.statValue}>Khoảng {estimatedDuration} giây</span>
            </div>
            <div className="w-px h-6 bg-[var(--bg-hover)]"></div>
            <div className={STYLES.statusPanel.stat}>
              <span className={STYLES.statusPanel.statLabel}>Thời lượng mục tiêu</span>
