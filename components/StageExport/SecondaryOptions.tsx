  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
      ...
      >
        ...
        <div>
          <h4 className="text-sm font-bold text-[var(--text-primary)] mb-1">Tài nguyên gốc</h4>
          <p className="text-[10px] text-[var(--text-tertiary)]">Tải xuống toàn bộ ảnh đã tạo và các đoạn video gốc.</p>
        </div>
      </div>
      ...
      <div className={STYLES.card.base}>
        ...
        <div>
          <h4 className="text-sm font-bold text-[var(--text-primary)] mb-1">Sao lưu dữ liệu</h4>
          <p className="text-[10px] text-[var(--text-tertiary)]">Xuất dữ liệu tập phim hiện tại hoặc nhập bản sao lưu từ thiết bị khác.</p>
          <div className="mt-3 flex gap-2">
            ...
            >
              {isDataExporting ? 'Đang xuất...' : 'Xuất tập hiện tại'}
            </button>
            <button
              type="button"
              onClick={(event) => {
            ...
            >
              {isDataImporting ? 'Đang nhập...' : 'Nhập'}
            </button>
          </div>
        </div>
      </div>
      ...
      >
        ...
        <div>
          <h4 className="text-sm font-bold text-[var(--text-primary)] mb-1">Nhật ký Render</h4>
          <p className="text-[10px] text-[var(--text-tertiary)]">Xem lịch sử tạo và trạng thái.</p>
        </div>
      </div>
    </div>
  );
