...
export const DEFAULTS = {
  ...
  batchGenerateDelay: 3000, // Độ trễ tạo hàng loạt (ms)
};

// Đặc trưng vùng miền
export const REGIONAL_FEATURES = {
  Vietnamese: {
    character: 'Vietnamese person, Southeast Asian facial features, Vietnamese ethnicity, ',
    scene: 'Vietnamese setting, Southeast Asian architecture and aesthetics, ',
  },
  Chinese: {
...
export const PROP_CATEGORIES = [
  { value: 'Vũ khí', label: 'Vũ khí' },
  { value: 'Tài liệu/Thư từ', label: 'Tài liệu/Thư từ' },
  { value: 'Thức ăn/Đồ uống', label: 'Thức ăn/Đồ uống' },
  { value: 'Phương tiện', label: 'Phương tiện' },
  { value: 'Trang sức/Trang trí', label: 'Trang sức/Trang trí' },
  { value: 'Thiết bị công nghệ', label: 'Thiết bị công nghệ' },
  { value: 'Vật phẩm tự nhiên', label: 'Vật phẩm tự nhiên' },
