        ...
        <div className="h-16 px-8 border-b border-[var(--border-primary)] flex items-center justify-between shrink-0 bg-[var(--bg-elevated)]">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-[var(--text-tertiary)] font-mono uppercase tracking-wider">Tủ đồ & Biến thể nhân vật</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div>
              <h4 className="text-xs font-bold text-[var(--text-tertiary)] uppercase tracking-widest mb-4 flex items-center gap-2">
                <User className="w-4 h-4" /> Ngoại hình gốc
              </h4>
              <div className="bg-[var(--bg-primary)] p-4 rounded-xl border border-[var(--border-primary)]">
                ...
                >
                  {character.referenceImage ? (
                    ...
                    <div className="flex items-center justify-center h-full text-[var(--text-muted)]">Chưa có ảnh</div>
                  )}
            ...
            <div>
              <div className="flex items-center justify-between mb-4">
                <h4 className="text-xs font-bold text-[var(--text-tertiary)] uppercase tracking-widest flex items-center gap-2">
                  <Shirt className="w-4 h-4" /> Biến thể / Trang phục
                </h4>
              </div>
              ...
              <div className="space-y-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex gap-3">
                        ...
                        >
                          ...
                          {variation.status === 'failed' ? 'Thử lại' : variation.referenceImage ? 'Tạo lại' : 'Tạo tạo hình'}
                        </button>
                ...
                <div className="p-4 border border-dashed border-[var(--border-primary)] rounded-xl bg-[var(--bg-primary)]/50">
                  <div className="space-y-3">
                    <input 
                      type="text" 
                      placeholder="Tên biến thể (vd: Trang phục chiến đấu)" 
                      value={newVarName}
                    ...
                    />
                    <textarea 
                      placeholder="Mô tả ngoại hình/trang phục mới..."
                      value={newVarPrompt}
