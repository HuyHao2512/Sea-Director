/**
 * Cấu hình hướng dẫn bố cục chuyển động máy quay
 * Cung cấp gợi ý bố cục cho khung hình đầu và cuối của các loại chuyển động máy quay khác nhau
 */
...
/**
 * Trả về hướng dẫn bố cục theo loại chuyển động máy quay
 */
export const getCameraMovementCompositionGuide = (
  ...
  // Tìm loại chuyển động máy quay phù hợp
