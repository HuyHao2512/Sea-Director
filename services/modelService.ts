/**
 * Điểm vào thống nhất của dịch vụ mô hình
 * Lớp ứng dụng chỉ cần gọi các hàm này, không cần quan tâm đến mô hình cơ bản
 */
...
// Xuất ApiKeyError để sử dụng bên ngoài
export { ApiKeyError };
...
/**
 * Gọi mô hình đối thoại
 * @param options Tham số gọi
 * @returns Văn bản được tạo bởi AI
 */
...
/**
 * Gọi mô hình đối thoại (phản hồi định dạng JSON)
 * @param options Tham số gọi
 * @returns Chuỗi JSON được tạo bởi AI
 */
...
/**
 * Tạo hình ảnh
 * @param options Tham số tạo
 * @returns Dữ liệu hình ảnh ở định dạng Base64
 */
 ...
 * Tạo video
 * @param options Tham số tạo
 * @returns Dữ liệu video ở định dạng Base64
 */
...
// ============================================
// Các hàm kinh doanh nâng cao
// ============================================

/**
 * Phân tích kịch bản thành dữ liệu có cấu trúc
 */
...
/**
 * Lấy các tham số được hỗ trợ của mô hình video hiện tại
 */
...
// ============================================
// Các hàm xây dựng prompt (riêng tư)
// ============================================
